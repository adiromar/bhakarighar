            ...
            <div class="modal-body">
                ...
                <div class="col-md-6">
                        <form action="{{ route('update.order_status') }}" method="post">
                            ...
                            <label>Order Status</label>{{ $ord->order_status }}
                            <select name="order_status" class="form-control">
                                
    
                                    <option value="1" {{ $ord->order_status == '1' ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ $ord->order_status == '0' ? 'selected' : '' }}>Cancelled</option>
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12 m-3">
                                ...
                                <input type="submit" name="btnsub" value="Update Order Status" class="btn btn-primary btn-sm">
                            </div>
