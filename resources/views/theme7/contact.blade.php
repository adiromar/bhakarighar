			...
			<div class="col-lg-10 offset-lg-1">
				<div class="contact_info_container d-flex flex-lg-row flex-column justify-content-between align-items-between">
					...
					<div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
						<div class="contact_info_image"><img src="{{ asset('themes/7/images/contact_1.png') }}" alt=""></div>
					...
					<!-- Contact Item -->
					<div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
						<div class="contact_info_image"><img src="{{ asset('themes/7/images/contact_2.png') }}" alt=""></div>
						<div class="contact_info_content">
					...
					<!-- Contact Item -->
					<div class="contact_info_item d-flex flex-row align-items-center justify-content-start">
						<div class="contact_info_image"><img src="{{ asset('themes/7/images/contact_3.png') }}" alt=""></div>
						<div class="contact_info_content">
		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1">
				<div class="contact_form_container">
					...
					<form action="mail/mail.php" id="contact_form">
...
<script src="{{ asset('themes/7/js/contact_custom.js') }}"></script>
